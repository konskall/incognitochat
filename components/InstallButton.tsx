...
const InstallButton: React.FC = () => {
        ...
        >
            ...
            <div className="relative p-6 pt-8">
                <button 
                    ...
                    className="absolute top-4 right-4 p-1.5 bg-slate-100/80 dark:bg-slate-800/80 rounded-full text-slate-400 hover:text-slate-800 dark:hover:text-white transition-colors backdrop-blur-sm"
                >
                    <X size={16} />
                </button>
            ...
            <div className="p-4 bg-slate-50/80 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-700/50 text-center backdrop-blur-md">
                <button 
                        onClick={() => setShowIOSInstructions(false)}
  ...
  const UninstallModal = () => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xl animate-in fade-in duration-300" onClick={() => setShowUninstallInstructions(false)}>
  ...
  return (
    <>
        ...
        {showIOSInstructions && createPortal(<IOSModal />, document.body)}
        {showUninstallInstructions && createPortal(<UninstallModal />, document.body)}
    </>
  );
};
